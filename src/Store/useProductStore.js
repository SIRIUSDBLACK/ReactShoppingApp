...
const useProductStore = create((set) => ({
    products : [
      ...
      },
      {
        ...
        slug: "silicon-power-256gb-ssd-3d-nand-a55-slc-cache-performance-boost-sata-iii",
        price: 109,
        description:
          "3D NAND flash are applied to deliver high transfer speeds. Remarkable transfer speed that enables fast loading of games and smoother gameplay.",
        category: "electronics",
      ...
      },
      {
        ...
        price: 56.99,
        description:
          "Note:The Jackets is US standard size, Please choose size as your usual wear. Material: 100% Polyester, warm and water-repellent.",
      ...
      },
      {
        ...
        price: 29.95,
        description:
          "100% POLYURETHANE (shell) 100% POLYESTER (lining). Wipe clean with damp cloth. Removable hooded faux leather moto biker jacket.",
        category: "women's clothing",
      ...
      },
      {
        ...
        price: 9.85,
        description:
          "95% RAYON 5% SPANDEX Solid Color, Double stitching on bottom hem and sleeves for durability.",
        category: "women's clothing",
      ...
      },
      {
        ...
        price: 7.95,
        description:
          "100% Polyester, Machine wash, Lightweight and highly breathable moisture wicking fabric.",
        category: "women's clothing",
      ...
      },
      {
        ...
        price: 12.99,
        description:
          "95%Cotton,5%Spandex, Soft, Slim Fit, Comfortable and casual.",
        category: "women's clothing",
